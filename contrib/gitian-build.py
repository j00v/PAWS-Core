...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/pawsfund/gitian.sigs.git'])
    if not os.path.isdir('paws-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/pawsfund/paws-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('paws'):
        subprocess.check_call(['git', 'clone', 'https://github.com/pawsfund/paws-core.git'])
...
def build():
    ...
    os.makedirs('paws-binaries/' + args.version, exist_ok=True)
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/pawsfund/paws-core', help='Specify the URL of the repository. Default is %(default)s')
    ...
    if args.pull:
        ...
        os.chdir('../gitian-builder/inputs/paws-core')
        subprocess.check_call(['git', 'fetch', args.url, 'refs/pull/'+args.version+'/merge'])
